...
//   - Mobile : sidebar cachée, s'ouvre via
//              le contexte partagé avec App
// ============================================
...
// Contenu réutilisé dans desktop et mobile
...
// ============================================
// Bouton déconnexion — ajouté en bas de sidebar
// Remplacez la dernière ligne "ParkInfo v1.0"
// par ce composant dans SidebarContent
// ============================================
export function BoutonDeconnexion() {
  const handleDeconnexion = () => {
    localStorage.removeItem('parkinfo_session')
